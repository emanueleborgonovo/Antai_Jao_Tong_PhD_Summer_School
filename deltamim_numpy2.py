...
def deltamim(
    ...
    if o.PowerLoss != 0:
        ...
        efygm1 = np.trapezoid(f1 ** (gamma_power + 1), yy)
    ...
    for i in range(k):
        ...
        for m in range(M):
            ...
            if o.PowerLoss != 0:
                Sr[m] = o.PowerLossScale * (np.trapezoid(f2 ** (gamma_power + 1), yy_backup) - efygm1)
                continue
            ...
            S = deltaoffset + 2 * deltafactor * np.trapezoid(ff, yy_cur)
